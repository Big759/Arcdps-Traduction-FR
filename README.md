...
```bash
C:\Program Files\Guild Wars 2\addons\arcdps\
```
ou :
```bash
C:\Program Files (x86)\Guild Wars 2\addons\arcdps\
```

Exemple avec Lutris :
```
.../guild-wars-2/drive_c/Program Files/Guild Wars 2/addons/arcdps/
```
...
- Taille de police recommandée : 13.0 (sur un écran 23-24 pouces)
